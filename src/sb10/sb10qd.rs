//! SB10QD — H-infinity controller (continuous) from state feedback and output injection.

use nalgebra::DMatrix;

/// Forms H-infinity controller K from F, H and transformation matrices.
pub fn sb10qd(
    n: usize,
    m: usize,
    np: usize,
    ...
    crate::sb10::sb10wd::sb10wd(n, m, np, ncon, nmeas, a, b, c, d, f, h, tu, ty, ak, bk, ck, dk)
}
...
mod tests {
    ...
    fn test_sb10qd_n0() {
        ...
        assert_eq!(sb10qd(0, 2, 2, 1, 1, &a, &b, &c, &d, &f, &h, &tu, &ty, &mut ak, &mut bk, &mut ck, &mut dk), 0);
    }
}
