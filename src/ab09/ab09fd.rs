//! AB09FD — B&T with coprime factors (SLICOT). TB01ID, SB08ED, SB08CD, AB09AX, SB08GD/FD/DD/HD.

use nalgebra::DMatrix;

use crate::ab09::ab09ax::ab09ax_simple;
...
#[inline]
pub fn ab09fd(n: usize, m: usize) -> i32 {
    if n == 0 && m == 0 {
        return 0;
    }
    let p = m;
...
mod tests {
    ...
    #[test]
    fn test_ab09fd_trivial() {
        assert_eq!(ab09fd(0, 0), 0);
    }
}
